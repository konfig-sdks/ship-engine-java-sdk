...
import com.konfigthis.client.model.DangerousGoods;
...
public class Products {
  ...
  public static final String SERIALIZED_NAME_MID_CODE = "mid_code";
  @SerializedName(SERIALIZED_NAME_MID_CODE)
  ...
  **/
  ...
  public Products value(MonetaryValue value) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The declared value of each item")
  ...
  public Products weight(Weight weight) {
  ...
  **/
  ...
  public Products harmonizedTariffCode(String harmonizedTariffCode) {
  ...
  **/
  ...
  public Products countryOfOrigin(String countryOfOrigin) {
  ...
  **/
  ...
  public Products unitOfMeasure(String unitOfMeasure) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The SKU (Stock Keeping Unit) of the item")
  ...
  public Products skuDescription(String skuDescription) {
  ...
  **/
  ...
  public Products midCode(String midCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Manufacturers Identification code")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "link to the item on the seller website")
  ...
  public Products vatRate(Double vatRate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0.2", value = "VAT rate applicable to the item")
  ...
  public Products dangerousGoods(List<DangerousGoods> dangerousGoods) {
  ...
  public Products addDangerousGoodsItem(DangerousGoods dangerousGoodsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "[]", value = "Details about dangerous goods inside products")
   ...
   * @return the Products instance itself
   */
  public Products putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, products.description) &&
        Objects.equals(this.quantity, products.quantity) &&
        Objects.equals(this.value, products.value) &&
        Objects.equals(this.weight, products.weight) &&
        Objects.equals(this.harmonizedTariffCode, products.harmonizedTariffCode) &&
        Objects.equals(this.countryOfOrigin, products.countryOfOrigin) &&
        Objects.equals(this.unitOfMeasure, products.unitOfMeasure) &&
        Objects.equals(this.sku, products.sku) &&
        Objects.equals(this.skuDescription, products.skuDescription) &&
        Objects.equals(this.midCode, products.midCode) &&
        Objects.equals(this.productUrl, products.productUrl) &&
        Objects.equals(this.vatRate, products.vatRate) &&
        Objects.equals(this.dangerousGoods, products.dangerousGoods)&&
        Objects.equals(this.additionalProperties, products.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, quantity, value, weight, harmonizedTariffCode, countryOfOrigin, unitOfMeasure, sku, skuDescription, midCode, productUrl, vatRate, dangerousGoods, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Products
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Products.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("value") != null && !jsonObj.get("value").isJsonNull()) {
        MonetaryValue.validateJsonObject(jsonObj.getAsJsonObject("value"));
      }
      ...
      if (!jsonObj.get("mid_code").isJsonNull() && (jsonObj.get("mid_code") != null && !jsonObj.get("mid_code").isJsonNull()) && !jsonObj.get("mid_code").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `mid_code` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mid_code").toString()));
      }
      ...
      if (jsonObj.get("dangerous_goods") != null && !jsonObj.get("dangerous_goods").isJsonNull()) {
        JsonArray jsonArraydangerousGoods = jsonObj.getAsJsonArray("dangerous_goods");
        if (jsonArraydangerousGoods != null) {
          // ensure the json data is an array
          if (!jsonObj.get("dangerous_goods").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `dangerous_goods` to be an array in the JSON string but got `%s`", jsonObj.get("dangerous_goods").toString()));
          }

          // validate the optional field `dangerous_goods` (array)
          for (int i = 0; i < jsonArraydangerousGoods.size(); i++) {
            DangerousGoods.validateJsonObject(jsonArraydangerousGoods.get(i).getAsJsonObject());
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Products>() {
           ...
           public Products read(JsonReader in) throws IOException {
             ...
             Products instance = thisAdapter.fromJsonTree(jsonObj);
