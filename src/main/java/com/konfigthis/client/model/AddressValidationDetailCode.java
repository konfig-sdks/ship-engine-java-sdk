 ...
 */
@JsonAdapter(AddressValidationDetailCode.Adapter.class)public enum AddressValidationDetailCode {
  ...
  AddressValidationDetailCode(String value) {
    this.value = value;
  }
  ...
  public static AddressValidationDetailCode fromValue(String value) {
    for (AddressValidationDetailCode b : AddressValidationDetailCode.values()) {
  ...
  public static class Adapter extends TypeAdapter<AddressValidationDetailCode> {
    @Override
    public void write(final JsonWriter jsonWriter, final AddressValidationDetailCode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AddressValidationDetailCode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AddressValidationDetailCode.fromValue(value);
    }
  }
}
