...
import com.konfigthis.client.model.ErrorType;
 ...
 */
@ApiModel(description = "The error structure that gets returned with almost all failed API calls ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Error {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Body of request cannot be null.", required = true, value = "An error message associated with the failed API call")
  ...
  public boolean equals(Object o) {
    ...
    Error error = (Error) o;
    return Objects.equals(this.errorSource, error.errorSource) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(errorSource, errorType, errorCode, message, additionalProperties);
  }
