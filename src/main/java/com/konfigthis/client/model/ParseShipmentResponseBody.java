 ...
 */
@ApiModel(description = "The parsed shipment, as well as a confidence score and a list of all the shipping entities that were recognized in the text. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ParseShipmentResponseBody {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The parsed shipment.  This shipment may not be complete, depending on how much information was included in the text and how confident the API is about each recognized entity.  > **Note:** The shipment-recognition API does not currently perform any validation of the parsed addresses, so we recommend that you use the [address-validation API](https://www.shipengine.com/docs/addresses/validation/) to ensure that the addresses are correct. ")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "All of the entities that were recognized in the text. An \"entity\" is a single piece of data, such as a city, a postal code, a carrier name, or a package weight.  Each entity includes the original text and the parsed value. ")
   ...
   * @return the ParseShipmentResponseBody instance itself
   */
  public ParseShipmentResponseBody putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.score, parseShipmentResponseBody.score) &&
        Objects.equals(this.shipment, parseShipmentResponseBody.shipment) &&
        Objects.equals(this.entities, parseShipmentResponseBody.entities)&&
        Objects.equals(this.additionalProperties, parseShipmentResponseBody.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(score, shipment, entities, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ParseShipmentResponseBody
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ParseShipmentResponseBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ParseShipmentResponseBody>() {
           ...
           public ParseShipmentResponseBody read(JsonReader in) throws IOException {
             ...
             ParseShipmentResponseBody instance = thisAdapter.fromJsonTree(jsonObj);
