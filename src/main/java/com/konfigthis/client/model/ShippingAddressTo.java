...
import com.konfigthis.client.model.PartialShippingAddressToGeolocationInner;
...
public class ShippingAddressTo {
  ...
  private List<PartialShippingAddressToGeolocationInner> geolocation = null;

  public ShippingAddressTo() {
  }

  public ShippingAddressTo name(String name) {
  ...
  **/
  ...
  public ShippingAddressTo phone(String phone) {
  ...
  **/
  ...
  public ShippingAddressTo email(String email) {
  ...
  **/
  ...
  public ShippingAddressTo companyName(String companyName) {
  ...
  **/
  ...
  public ShippingAddressTo addressLine1(String addressLine1) {
  ...
  **/
  ...
  public ShippingAddressTo addressLine2(String addressLine2) {
  ...
  **/
  ...
  public ShippingAddressTo addressLine3(String addressLine3) {
  ...
  **/
  ...
  public ShippingAddressTo cityLocality(String cityLocality) {
  ...
  **/
  ...
  public ShippingAddressTo stateProvince(String stateProvince) {
  ...
  **/
  ...
  public ShippingAddressTo postalCode(String postalCode) {
  ...
  **/
  ...
  public ShippingAddressTo countryCode(String countryCode) {
  ...
  **/
  ...
  public ShippingAddressTo addressResidentialIndicator(AddressResidentialIndicator addressResidentialIndicator) {
  ...
  **/
  ...
  public ShippingAddressTo instructions(String instructions) {
    
    
    if (instructions != null && instructions.length() < 1) {
      throw new IllegalArgumentException("Invalid value for instructions. Length must be greater than or equal to 1.");
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Additional text about how to handle the shipment at this address. ")
  ...
  public ShippingAddressTo geolocation(List<PartialShippingAddressToGeolocationInner> geolocation) {
  ...
  public ShippingAddressTo addGeolocationItem(PartialShippingAddressToGeolocationInner geolocationItem) {
  ...
  **/
  ...
  public List<PartialShippingAddressToGeolocationInner> getGeolocation() {
    return geolocation;
  }


  public void setGeolocation(List<PartialShippingAddressToGeolocationInner> geolocation) {
   ...
   * @return the ShippingAddressTo instance itself
   */
  public ShippingAddressTo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ShippingAddressTo shippingAddressTo = (ShippingAddressTo) o;
    return Objects.equals(this.name, shippingAddressTo.name) &&
        Objects.equals(this.phone, shippingAddressTo.phone) &&
        Objects.equals(this.email, shippingAddressTo.email) &&
        Objects.equals(this.companyName, shippingAddressTo.companyName) &&
        Objects.equals(this.addressLine1, shippingAddressTo.addressLine1) &&
        Objects.equals(this.addressLine2, shippingAddressTo.addressLine2) &&
        Objects.equals(this.addressLine3, shippingAddressTo.addressLine3) &&
        Objects.equals(this.cityLocality, shippingAddressTo.cityLocality) &&
        Objects.equals(this.stateProvince, shippingAddressTo.stateProvince) &&
        Objects.equals(this.postalCode, shippingAddressTo.postalCode) &&
        Objects.equals(this.countryCode, shippingAddressTo.countryCode) &&
        Objects.equals(this.addressResidentialIndicator, shippingAddressTo.addressResidentialIndicator) &&
        Objects.equals(this.instructions, shippingAddressTo.instructions) &&
        Objects.equals(this.geolocation, shippingAddressTo.geolocation)&&
        Objects.equals(this.additionalProperties, shippingAddressTo.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, phone, email, companyName, addressLine1, addressLine2, addressLine3, cityLocality, stateProvince, postalCode, countryCode, addressResidentialIndicator, instructions, geolocation, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShippingAddressTo
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShippingAddressTo.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShippingAddressTo is not found in the empty JSON string", ShippingAddressTo.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("geolocation") != null && !jsonObj.get("geolocation").isJsonNull()) {
        JsonArray jsonArraygeolocation = jsonObj.getAsJsonArray("geolocation");
        if (jsonArraygeolocation != null) {
          // ensure the json data is an array
          if (!jsonObj.get("geolocation").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `geolocation` to be an array in the JSON string but got `%s`", jsonObj.get("geolocation").toString()));
          }

          // validate the optional field `geolocation` (array)
          for (int i = 0; i < jsonArraygeolocation.size(); i++) {
            PartialShippingAddressToGeolocationInner.validateJsonObject(jsonArraygeolocation.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShippingAddressTo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShippingAddressTo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShippingAddressTo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShippingAddressTo.class));

       return (TypeAdapter<T>) new TypeAdapter<ShippingAddressTo>() {
           @Override
           public void write(JsonWriter out, ShippingAddressTo value) throws IOException {
           ...
           @Override
           public ShippingAddressTo read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ShippingAddressTo instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ShippingAddressTo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShippingAddressTo
  * @throws IOException if the JSON string is invalid with respect to ShippingAddressTo
  */
  public static ShippingAddressTo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShippingAddressTo.class);
  }

 /**
  * Convert an instance of ShippingAddressTo to an JSON string
  *
  * @return JSON string
  */
