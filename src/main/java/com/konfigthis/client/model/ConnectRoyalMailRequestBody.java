 ...
 */
@ApiModel(description = "A Royal Mail account information request body")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ConnectRoyalMailRequestBody {
  ...
  **/
  ...
  public ConnectRoyalMailRequestBody obaEmail(String obaEmail) {
    ...
    if (obaEmail != null && obaEmail.length() < 1) {
      throw new IllegalArgumentException("Invalid value for obaEmail. Length must be greater than or equal to 1.");
    }
  ...
  **/
  ...
  @ApiModelProperty(example = "john.doe@example.com", value = "An email address.")
  ...
  public ConnectRoyalMailRequestBody contactName(String contactName) {
    ...
    if (contactName != null && contactName.length() < 1) {
      throw new IllegalArgumentException("Invalid value for contactName. Length must be greater than or equal to 1.");
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Street line1")
  ...
  public ConnectRoyalMailRequestBody streetLine2(String streetLine2) {
    ...
    if (streetLine2 != null && streetLine2.length() < 1) {
      throw new IllegalArgumentException("Invalid value for streetLine2. Length must be greater than or equal to 1.");
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Street line2")
  ...
  public ConnectRoyalMailRequestBody streetLine3(String streetLine3) {
    ...
    if (streetLine3 != null && streetLine3.length() < 1) {
      throw new IllegalArgumentException("Invalid value for streetLine3. Length must be greater than or equal to 1.");
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Street line3")
  ...
  **/
   ...
   * @return the ConnectRoyalMailRequestBody instance itself
   */
  public ConnectRoyalMailRequestBody putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountNumber, connectRoyalMailRequestBody.accountNumber) &&
        ...
        Objects.equals(this.additionalProperties, connectRoyalMailRequestBody.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountNumber, obaEmail, contactName, email, companyName, streetLine1, streetLine2, streetLine3, city, postalCode, phone, nickname, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConnectRoyalMailRequestBody
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConnectRoyalMailRequestBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ConnectRoyalMailRequestBody>() {
           ...
           public ConnectRoyalMailRequestBody read(JsonReader in) throws IOException {
             ...
             ConnectRoyalMailRequestBody instance = thisAdapter.fromJsonTree(jsonObj);
