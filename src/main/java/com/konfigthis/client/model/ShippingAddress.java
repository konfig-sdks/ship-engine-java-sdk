...
public class ShippingAddress {
  ...
  **/
   ...
   * @return the ShippingAddress instance itself
   */
  public ShippingAddress putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, shippingAddress.name) &&
        ...
        Objects.equals(this.additionalProperties, shippingAddress.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, phone, email, companyName, addressLine1, addressLine2, addressLine3, cityLocality, stateProvince, postalCode, countryCode, addressResidentialIndicator, instructions, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ShippingAddress>() {
           ...
           public ShippingAddress read(JsonReader in) throws IOException {
             ...
             ShippingAddress instance = thisAdapter.fromJsonTree(jsonObj);
