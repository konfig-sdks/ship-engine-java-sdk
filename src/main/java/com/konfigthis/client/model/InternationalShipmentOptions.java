...
public class InternationalShipmentOptions {
  ...
  public InternationalShipmentOptions() {
  }

  public InternationalShipmentOptions contents(PackageContents contents) {
  ...
  **/
  ...
  public InternationalShipmentOptions contentsExplanation(String contentsExplanation) {
  ...
  **/
  ...
  public InternationalShipmentOptions nonDelivery(NonDelivery nonDelivery) {
  ...
  **/
  ...
  public InternationalShipmentOptions termsOfTradeCode(AllowedIncoterms termsOfTradeCode) {
  ...
  **/
  ...
  public InternationalShipmentOptions declaration(String declaration) {
  ...
  **/
  ...
  public InternationalShipmentOptions invoiceAdditionalDetails(InvoiceAdditionalDetails invoiceAdditionalDetails) {
  ...
  **/
  ...
  public InternationalShipmentOptions importerOfRecord(ImporterOfRecords importerOfRecord) {
  ...
  **/
  ...
  public InternationalShipmentOptions customsItems(List<CustomsItem> customsItems) {
  ...
  public InternationalShipmentOptions addCustomsItemsItem(CustomsItem customsItemsItem) {
  ...
  **/
   ...
   * @return the InternationalShipmentOptions instance itself
   */
  public InternationalShipmentOptions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InternationalShipmentOptions internationalShipmentOptions = (InternationalShipmentOptions) o;
    return Objects.equals(this.contents, internationalShipmentOptions.contents) &&
        Objects.equals(this.contentsExplanation, internationalShipmentOptions.contentsExplanation) &&
        Objects.equals(this.nonDelivery, internationalShipmentOptions.nonDelivery) &&
        Objects.equals(this.termsOfTradeCode, internationalShipmentOptions.termsOfTradeCode) &&
        Objects.equals(this.declaration, internationalShipmentOptions.declaration) &&
        Objects.equals(this.invoiceAdditionalDetails, internationalShipmentOptions.invoiceAdditionalDetails) &&
        Objects.equals(this.importerOfRecord, internationalShipmentOptions.importerOfRecord) &&
        Objects.equals(this.customsItems, internationalShipmentOptions.customsItems)&&
        Objects.equals(this.additionalProperties, internationalShipmentOptions.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InternationalShipmentOptions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InternationalShipmentOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InternationalShipmentOptions is not found in the empty JSON string", InternationalShipmentOptions.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InternationalShipmentOptions.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InternationalShipmentOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InternationalShipmentOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InternationalShipmentOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InternationalShipmentOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<InternationalShipmentOptions>() {
           @Override
           public void write(JsonWriter out, InternationalShipmentOptions value) throws IOException {
           ...
           @Override
           public InternationalShipmentOptions read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InternationalShipmentOptions instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InternationalShipmentOptions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InternationalShipmentOptions
  * @throws IOException if the JSON string is invalid with respect to InternationalShipmentOptions
  */
  public static InternationalShipmentOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InternationalShipmentOptions.class);
  }

 /**
  * Convert an instance of InternationalShipmentOptions to an JSON string
  *
  * @return JSON string
  */
