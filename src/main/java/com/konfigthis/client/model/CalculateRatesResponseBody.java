 ...
 */
@ApiModel(description = "A rate shipment response body")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CalculateRatesResponseBody {
  ...
  **/
  ...
  @ApiModelProperty(example = "[]", required = true, value = "Arbitrary tags associated with this shipment.  Tags can be used to categorize shipments, and shipments can be queried by their tags. ")
  ...
  public CalculateRatesResponseBody shipmentId(String shipmentId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2018-09-23T00:00Z", required = true, value = "An [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) string that represents a date, but not a specific time.  The value _may_ contain a time component, but it will be set to `00:00:00` UTC by ShipEngine. ")
  ...
  public CalculateRatesResponseBody createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public CalculateRatesResponseBody modifiedAt(OffsetDateTime modifiedAt) {
  ...
  **/
  ...
  public CalculateRatesResponseBody shipmentStatus(ShipmentStatus shipmentStatus) {
  ...
  **/
  ...
  public CalculateRatesResponseBody shipTo(ShippingAddressTo shipTo) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The recipient's mailing address")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The shipment's origin address. If you frequently ship from the same location, consider [creating a warehouse](https://www.shipengine.com/docs/reference/create-warehouse/).  Then you can simply specify the `warehouse_id` rather than the complete address each time. ")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The return address for this shipment.  Defaults to the `ship_from` address. ")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The type of delivery confirmation that is required for this shipment.")
  ...
  public CalculateRatesResponseBody customs(InternationalShipmentOptionsNullable customs) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "Customs information.  This is usually only needed for international shipments. ")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Advanced shipment options.  These are entirely optional.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The insurance provider to use for any insured packages in the shipment. ")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The packages in the shipment.  > **Note:** Some carriers only allow one package per shipment.  If you attempt to create a multi-package shipment for a carrier that doesn't allow it, an error will be returned. ")
  ...
  public CalculateRatesResponseBody totalWeight(Weight totalWeight) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The combined weight of all packages in the shipment")
  ...
  public CalculateRatesResponseBody comparisonRateType(String comparisonRateType) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The rates response")
   ...
   * @return the CalculateRatesResponseBody instance itself
   */
  public CalculateRatesResponseBody putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, calculateRatesResponseBody.tags) &&
        ...
        Objects.equals(this.advancedOptions, calculateRatesResponseBody.advancedOptions) &&
        ...
        Objects.equals(this.comparisonRateType, calculateRatesResponseBody.comparisonRateType) &&
        Objects.equals(this.rateResponse, calculateRatesResponseBody.rateResponse)&&
        Objects.equals(this.additionalProperties, calculateRatesResponseBody.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, shipmentId, carrierId, serviceCode, externalOrderId, items, taxIdentifiers, externalShipmentId, shipmentNumber, shipDate, createdAt, modifiedAt, shipmentStatus, shipTo, shipFrom, warehouseId, returnTo, isReturn, confirmation, customs, advancedOptions, insuranceProvider, orderSourceCode, packages, totalWeight, comparisonRateType, rateResponse, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CalculateRatesResponseBody
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CalculateRatesResponseBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      RatesInformation.validateJsonObject(jsonObj.getAsJsonObject("rate_response"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CalculateRatesResponseBody>() {
           ...
           public CalculateRatesResponseBody read(JsonReader in) throws IOException {
             ...
             CalculateRatesResponseBody instance = thisAdapter.fromJsonTree(jsonObj);
