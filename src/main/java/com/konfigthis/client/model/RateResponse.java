...
public class RateResponse {
  ...
  **/
  ...
  @ApiModelProperty(value = "The rates response")
   ...
   * @return the RateResponse instance itself
   */
  public RateResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.rateResponse, rateResponse.rateResponse)&&
        Objects.equals(this.additionalProperties, rateResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rateResponse, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to RateResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RateResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RateResponse>() {
           ...
           public RateResponse read(JsonReader in) throws IOException {
             ...
             RateResponse instance = thisAdapter.fromJsonTree(jsonObj);
