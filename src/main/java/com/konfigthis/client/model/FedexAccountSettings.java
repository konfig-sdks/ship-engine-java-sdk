...
import com.konfigthis.client.model.FedexPickupType;
import com.konfigthis.client.model.SmartPostHub;
 ...
 */
@ApiModel(description = "A Fedex account settings request body")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FedexAccountSettings {
  ...
  public FedexAccountSettings() {
  }

  public FedexAccountSettings nickname(String nickname) {
  ...
  **/
  ...
  public FedexAccountSettings pickupType(FedexPickupType pickupType) {
  ...
  **/
  ...
  public FedexAccountSettings smartPostHub(SmartPostHub smartPostHub) {
  ...
  **/
  ...
  public FedexAccountSettings smartPostEndorsement(AncillaryServiceEndorsement smartPostEndorsement) {
  ...
  **/
  ...
  public FedexAccountSettings isPrimaryAccount(Boolean isPrimaryAccount) {
  ...
  **/
  ...
  public FedexAccountSettings signatureImage(String signatureImage) {
  ...
  **/
  ...
  public FedexAccountSettings letterheadImage(String letterheadImage) {
  ...
  **/
   ...
   * @return the FedexAccountSettings instance itself
   */
  public FedexAccountSettings putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FedexAccountSettings fedexAccountSettings = (FedexAccountSettings) o;
    return Objects.equals(this.nickname, fedexAccountSettings.nickname) &&
        Objects.equals(this.pickupType, fedexAccountSettings.pickupType) &&
        Objects.equals(this.smartPostHub, fedexAccountSettings.smartPostHub) &&
        Objects.equals(this.smartPostEndorsement, fedexAccountSettings.smartPostEndorsement) &&
        Objects.equals(this.isPrimaryAccount, fedexAccountSettings.isPrimaryAccount) &&
        Objects.equals(this.signatureImage, fedexAccountSettings.signatureImage) &&
        Objects.equals(this.letterheadImage, fedexAccountSettings.letterheadImage)&&
        Objects.equals(this.additionalProperties, fedexAccountSettings.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nickname, pickupType, smartPostHub, smartPostEndorsement, isPrimaryAccount, signatureImage, letterheadImage, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FedexAccountSettings
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FedexAccountSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FedexAccountSettings is not found in the empty JSON string", FedexAccountSettings.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FedexAccountSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FedexAccountSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FedexAccountSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FedexAccountSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<FedexAccountSettings>() {
           @Override
           public void write(JsonWriter out, FedexAccountSettings value) throws IOException {
           ...
           @Override
           public FedexAccountSettings read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FedexAccountSettings instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FedexAccountSettings given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FedexAccountSettings
  * @throws IOException if the JSON string is invalid with respect to FedexAccountSettings
  */
  public static FedexAccountSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FedexAccountSettings.class);
  }

 /**
  * Convert an instance of FedexAccountSettings to an JSON string
  *
  * @return JSON string
  */
