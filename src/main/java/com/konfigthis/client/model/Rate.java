 ...
 * A rate
 */
@ApiModel(description = "A rate")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Rate {
  ...
  **/
  ...
  public Rate rateType(RateType rateType) {
  ...
  **/
  ...
  public Rate shippingAmount(MonetaryValue shippingAmount) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The shipping amount. Should be added with confirmation_amount, insurance_amount and other_amount to calculate the total purchase price.")
  ...
  public Rate insuranceAmount(MonetaryValue insuranceAmount) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The insurance amount.  Should be added with shipping_amount, confirmation_amount and other_amount to calculate the total purchase price.")
  ...
  public Rate confirmationAmount(MonetaryValue confirmationAmount) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The confirmation amount.  Should be added with shipping_amount, insurance_amount and other_amount to calculate the total purchase price.")
  ...
  public Rate otherAmount(MonetaryValue otherAmount) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Any other charges associated with this rate.  Should be added with shipping_amount, insurance_amount and confirmation_amount to calculate the total purchase price.")
  ...
  public Rate requestedComparisonAmount(MonetaryValue requestedComparisonAmount) {
  ...
  **/
  ...
  public Rate taxAmount(MonetaryValue taxAmount) {
  ...
  **/
  ...
  public Rate estimatedDeliveryDate(OffsetDateTime estimatedDeliveryDate) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "carrier code")
  ...
  **/
  ...
  public Rate validationStatus(ValidationStatus validationStatus) {
  ...
  **/
   ...
   * @return the Rate instance itself
   */
  public Rate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.rateId, rate.rateId) &&
        ...
        Objects.equals(this.requestedComparisonAmount, rate.requestedComparisonAmount) &&
        ...
        Objects.equals(this.carrierCode, rate.carrierCode) &&
        ...
        Objects.equals(this.additionalProperties, rate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rateId, rateType, carrierId, shippingAmount, insuranceAmount, confirmationAmount, otherAmount, requestedComparisonAmount, taxAmount, zone, packageType, deliveryDays, guaranteedService, estimatedDeliveryDate, carrierDeliveryDays, shipDate, negotiatedRate, serviceType, serviceCode, trackable, carrierCode, carrierNickname, carrierFriendlyName, validationStatus, warningMessages, errorMessages, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Rate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Rate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Rate>() {
           ...
           public Rate read(JsonReader in) throws IOException {
             ...
             Rate instance = thisAdapter.fromJsonTree(jsonObj);
