...
public class TrackingApiTest {
    ...
    private static TrackingApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new TrackingApi(apiClient);
    }
     ...
     */
    @Test
    public void infoRetrievalTest() throws ApiException {
        String carrierCode = null;
        String trackingNumber = null;
        TrackingInformation response = api.infoRetrieval()
     ...
     */
    @Test
    public void trackingTest() throws ApiException {
        String carrierCode = null;
        String trackingNumber = null;
        String response = api.tracking()
                .carrierCode(carrierCode)
                .trackingNumber(trackingNumber)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void tracking_0Test() throws ApiException {
        String carrierCode = null;
        String trackingNumber = null;
        String response = api.tracking_0()
                .carrierCode(carrierCode)
                .trackingNumber(trackingNumber)
                .execute();
        // TODO: test validations
